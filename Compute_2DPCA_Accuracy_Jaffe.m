...
for i = 1:iterations
    ...
    end_time = clock;
    fprintf('This is the %d-th iteration of 2DPCA on Jaffe_32X32, the elapsed time is %f s \n',i,etime(end_time,start_time));
end
save('.\result\Jaffe_Orignal','ACC_D2PCA','-append');
...
save('.\result\Jaffe_16X16','ACC_D2PCA','-append');
...
save('.\result\Jaffe_23X23','ACC_D2PCA','-append');
