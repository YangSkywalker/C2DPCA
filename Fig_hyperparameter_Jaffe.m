%% ===== Jaffe_32X32 Original=====
clear all; clc

load('.\result\Jaffe_Orignal_hyperparameter.mat');     % load data
...
%% ===== Jaffe_32X32 16X16 nosie=====
clear all; clc

load('.\result\Jaffe_16X16_hyperparameter.mat');       % load data
...
load('.\result\Jaffe_23X23_hyperparameter.mat');       % load data
