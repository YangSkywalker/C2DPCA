...
%     end
% end
% save('.\result\Yale_Original_hyperparameter','ACC_C2DPCA');
% 
% 
...
% end
% save('.\result\Yale_Original_hyperparameter','ACC_Lp2DPCA','-append');
...
for si = s
    for pi = p
        ...
        for i = 1:iterations
            ...
            % compute principal components of G2DPCA
            start_time = clock;
...
save('.\result\Yale_Original_hyperparameter','ACC_G2DPCA','-append');
...
save('.\result\Yale_Original_hyperparameter','ACC_FCPCA','-append');
...
save('.\result\Yale_Original_hyperparameter','ACC_Capped2DPCAOM','-append');
...
save('.\result\Yale_Original_hyperparameter','ACC_D2PCA2Lp','space','-append');
