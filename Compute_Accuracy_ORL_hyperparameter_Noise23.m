...
%     end
% end
% save('.\result\ORL_23X23','ACC_C2DPCA');
% 
...
% end
% save('.\result\ORL_23X23','ACC_Lp2DPCA','-append');
% 
...
%     end
% end
% save('.\result\ORL_23X23','ACC_G2DPCA','-append');
% 
...
%     end
% end
% save('.\result\ORL_23X23','ACC_FCPCA','-append');
...
save('.\result\ORL_23X23','ACC_Capped2DPCAOM','-append');
...
save('.\result\ORL_23X23','ACC_D2PCA2Lp','space','-append');
