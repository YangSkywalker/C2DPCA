...
save('.\result\Yale_16X16_hyperparameter','ACC_C2DPCA');
...
save('.\result\Yale_16X16_hyperparameter','ACC_Lp2DPCA','-append');
...
save('.\result\Yale_16X16_hyperparameter','ACC_G2DPCA','-append');
...
save('.\result\Yale_16X16_hyperparameter','ACC_FCPCA','-append');
...
save('.\result\Yale_16X16_hyperparameter','ACC_Capped2DPCAOM','-append');
...
save('.\result\Yale_16X16_hyperparameter','ACC_D2PCA2Lp','space','-append');
