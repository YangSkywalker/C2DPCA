...
load('.\result\ORL_Orignal_hyperparameter.mat');      % load data
...
%% ===== ORL_32X32 16X16 nosie=====
clear all; clc

load('.\result\ORL_16X16_hyperparameter.mat');       % load data
...
load('.\result\ORL_23X23_hyperparameter.mat');       % load data
