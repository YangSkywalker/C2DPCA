...
% save('.\result\ORL_Original','ACC_C2DPCA');
...
save('.\result\ORL_Original','ACC_Lp2DPCA','-append');
...
save('.\result\ORL_Original','ACC_G2DPCA','-append');
...
save('.\result\ORL_Original','ACC_FCPCA','-append');
...
save('.\result\ORL_Original','ACC_Capped2DPCAOM','-append');
...
% save('.\result\ORL_Original','ACC_D2PCA2Lp','space','-append');
