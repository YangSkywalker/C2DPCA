...
load('.\result\Yale_Orignal_hyperparameter.mat');     % load data
...
%% ===== Yale_32X32 16X16 nosie=====
clear all; clc

load('.\result\Yale_16X16_hyperparameter.mat');       % load data
...
load('.\result\Yale_23X23_hyperparameter.mat');       % load data
