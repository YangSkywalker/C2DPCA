...
for i = 1:iterations
    ...
    end_time = clock;
    fprintf('This is the %d-th iteration of 2DPCA on Coil20_32X32, the elapsed time is %f s \n',i,etime(end_time,start_time));
end
save('.\result\Coil20_Orignal','ACC_D2PCA','-append');
...
save('.\result\Coil20_16X16','ACC_D2PCA','-append');
...
save('.\result\Coil20_23X23','ACC_D2PCA','-append');
